...
151__Login__AcceptDeny is an example of an OMM Interactive Provider application 
...
151__Login__AcceptDeny illustrates how to create and publish a single OMM
...
151__Login__AcceptDeny implements the following high-level steps:
...
+ Checks if login request nameType is USER_NAME.
  - If the username is "user", it accepts request using domain Login helper class
