...
140__MarketPrice__UserDispatch is an example of an OMM Interactive Provider application 
...
140__MarketPrice__UserDispatch illustrates how to create and publish a single OMM
...
140__MarketPrice__UserDispatch implements the following high-level steps:
