...
150__Login__AcceptDeny is an example of an OMM Interactive Provider application 
...
150__Login__AcceptDeny illustrates how to create and publish a single OMM
...
150__Login__AcceptDeny implements the following high-level steps:
