...
public class ConsPerfConfig
{
	...
	private int _highWaterMark;				/* sets the point which will cause UPA to automatically flush */
	...
	
    {
        ...
        CommandLine.addOption("inputBufs", 15, "Number of input buffers(configures numInputBufs in UPA connection)");
