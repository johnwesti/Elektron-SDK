...
100__MarketPrice__Snapshot is an example of an OMM Interactive Provider application 
...
100__MarketPrice__Snapshot illustrates how to create and publish a single OMM
...
100__MarketPrice__Snapshot implements the following high-level steps:
