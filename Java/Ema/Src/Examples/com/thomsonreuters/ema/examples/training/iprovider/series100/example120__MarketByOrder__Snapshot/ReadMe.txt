...
120__MarketByOrder__Snapshot is an example of an OMM Interactive Provider application 
...
120__MarketByOrder__Snapshot illustrates how to create and publish a single OMM
...
120__MarketByOrder__Snapshot implements the following high-level steps:
