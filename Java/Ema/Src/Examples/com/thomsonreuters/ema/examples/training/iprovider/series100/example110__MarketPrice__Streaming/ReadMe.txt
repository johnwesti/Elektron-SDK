...
110__MarketPrice__Streaming is an example of an OMM Interactive Provider application 
...
110__MarketPrice__Streaming illustrates how to create and publish a single OMM
...
110__MarketPrice__Streaming implements the following high-level steps:
