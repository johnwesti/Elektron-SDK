...
250__GroupStatus__Fanout is an example of an OMM Interactive Provider application 
...
250__GroupStatus__Fanout illustrates how to create and publish a single OMM
...
250__GroupStatus__Fanout implements the following high-level steps:
...
+ After submitting refresh and 10 updates,
  sends a directory update with group status (using the domain Directory helper class)
