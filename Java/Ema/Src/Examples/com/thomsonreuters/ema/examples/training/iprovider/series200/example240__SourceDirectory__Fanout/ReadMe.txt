...
240__SourceDirectory__Fanout is an example of an OMM Interactive Provider application 
...
240__SourceDirectory__Fanout illustrates how to create and publish a single OMM
...
240__SourceDirectory__Fanout implements the following high-level steps:
...
+ After submitting refresh and 10 updates,
  sends a directory update with service state change (using the domain Directory helper class)
