...
package com.thomsonreuters.ema.examples.training.iprovider.series100.example130__MarketByOrder__Streaming;
...
- responding to the market by order streaming request
	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			for( int i = 0; i < 60; i++ )
			{
				...
				provider.submit( EmaFactory.createUpdateMsg().payload( map ), appClient.itemHandle );
