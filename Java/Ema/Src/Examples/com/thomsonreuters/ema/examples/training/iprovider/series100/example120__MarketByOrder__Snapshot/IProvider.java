...
package com.thomsonreuters.ema.examples.training.iprovider.series100.example120__MarketByOrder__Snapshot;
...
class AppClient implements OmmProviderClient
{
	...
	void processMarketByOrderRequest(ReqMsg reqMsg, OmmProviderEvent event)
	{
		...
		event.provider().submit( EmaFactory.createRefreshMsg().domainType(EmaRdm.MMT_MARKET_BY_ORDER).name(reqMsg.name()).serviceName(reqMsg.serviceName()).solicited(true)
